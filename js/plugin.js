    ...
    function Slick(element, settings) {
      ...
      _.defaults = {
        ...
        customPaging: function(slider, i) {
          return $('<a data-role="none" role="button" tabindex="0"></a>').text(i + 1);
        },
        dots: false,
...
;(function($){
  ...
  $.fn.bxSlider = function(options){
    ...
    var appendControls = function(){
      slider.controls.next = $('<a class="bx-next" href=""><i class="ico">' + slider.settings.nextText + '</i></a>');
      slider.controls.prev = $('<a class="bx-prev" href=""><i class="ico">' + slider.settings.prevText + '</i></a>');
